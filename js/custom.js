...
const targetsansad = 38;
const targetsansadii = 13;
const targetsansadiii = 2.5;
const targetsansadiiii = 1.8;
...
let currenthelp =0;
     ...
     const siteVisitsObserver = new IntersectionObserver((entries) => {
      ...
      function updateCounters() {
        ...
        const stepComplaintRate = Math.ceil(targetComplaintRate / 100);
        ...
        const stepdistri = Math.ceil(targetdistri / 100);
        ...
        const interval = setInterval(() => {
          ...
          if (currentComplaintRate < targetComplaintRate) {
            ...
            complaintRateCounter.textContent = currentComplaintRate  + '+';
          }
          ...
          if (currentsansad < targetsansad) {
            ...
            sansad.textContent = currentsansad  + '+';
          }
          if (currentsansadii < targetsansadii) {
            currentsansadii += stepsansadii;
            sansadii.textContent = currentsansadii  + '+';
          }
          ...
          if (currentdistri < targetdistri) {
            ...
            distri.textContent = currentdistri + '+';
          }
          ...
          if (currentSiteVisits >= targetSiteVisits && currentMembersSigned >= targetMembersSigned && currentComplaintRate >= targetComplaintRate && currentwork >= targetworkcop && currentsansad >= targetsansad && currentsansadii >= targetsansadii && currentsansadiii >= targetsansadiii && currentsansadiiii >= targetsansadiiii && currentFood >= targetFood && currentvillage >= targetvillage && currentdistri >= targetdistri && currenthelp >= targethelp) {
